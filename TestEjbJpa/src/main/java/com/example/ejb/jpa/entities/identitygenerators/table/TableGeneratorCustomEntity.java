...
*/
@Entity
@Table(name="table_identity_generator_custom")
public class TableGeneratorCustomEntity implements Serializable{
	...
	//Here am creating talbeGenerator for this entity with name, but not specifying any other details. So defaults will apply.
	//So default hibernate_sequences table will be used, with new row for this generator whose name will be same as generator name as default
	...
	@Id
	@TableGenerator(name="TableGeneratorCustomEntity_GEN",allocationSize=1)
	@GeneratedValue(strategy=GenerationType.TABLE, generator="TableGeneratorCustomEntity_GEN")
	private Integer id;
